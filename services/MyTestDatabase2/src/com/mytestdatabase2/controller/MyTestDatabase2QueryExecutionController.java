...
package com.mytestdatabase2.controller;
...
import  com.mytestdatabase2.service.QueryExecutorService;
import com.wavemaker.runtime.data.model.CustomQuery;
import com.wavemaker.runtime.data.exception.QueryParameterMismatchException;

@RestController
@RequestMapping("/MyTestDatabase2/queryExecutor")
public class MyTestDatabase2QueryExecutionController {

	private static final Logger LOGGER = LoggerFactory.getLogger(MyTestDatabase2QueryExecutionController.class);

	@Autowired
	@Qualifier("MyTestDatabase2.queryExecutorService")
