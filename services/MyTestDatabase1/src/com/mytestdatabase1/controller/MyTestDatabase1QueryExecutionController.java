...
package com.mytestdatabase1.controller;
...
import  com.mytestdatabase1.service.QueryExecutorService;
import com.wavemaker.runtime.data.model.CustomQuery;
import com.wavemaker.runtime.data.exception.QueryParameterMismatchException;

@RestController
@RequestMapping("/MyTestDatabase1/queryExecutor")
public class MyTestDatabase1QueryExecutionController {

	private static final Logger LOGGER = LoggerFactory.getLogger(MyTestDatabase1QueryExecutionController.class);

	@Autowired
	@Qualifier("MyTestDatabase1.queryExecutorService")
